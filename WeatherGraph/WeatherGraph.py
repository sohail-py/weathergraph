...
class GetForecastGraph():

	def __init__(self):
		pass

	def generate_forecast_image(self, city, country, days_count, image_file_name = 'bar_chart'):
		'''
...
obj1 = WeatherGraph()
obj1.generate_forecast_image('London','uk',10, 'london_uk')